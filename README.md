...
### select * from movies_sql where lead_star='akshay kumar' and genre='comedy';
...
### select movie_name,budget from movies_sql where lead_star='salman khan'order by budget desc limit 5;
...
### select movie_name from movies_sql where lead_star='akshay kumar' and budget>revenue;
